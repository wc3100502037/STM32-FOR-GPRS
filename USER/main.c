...
int main(void)
 {u8 SMSFLAG=1,CheckFLAG=0;	
  ...
  u8 FLAG_JUDGE_GSM_DATA=255;                       //judge received GSM data to ensure the right format of datagram
	...
	FLAG_GPRS_Init=SIM900_GPRS_Init();             //STEP 1 to initiate GPRS function
...
/***********************************************************************************************/		
/*                                  ¶ÌÐÅ´¦Àí                                                   */
	  SMSREADTEST=SIM900_READ_TEXT_TEST(SMSLocationMode);	
		switch(SMSREADTEST)
		{
		...
		SMSREADTEST=5;// SMSLocationMode=2;	
/*                                 end of SMS handle                                             */
/*************************************************************************************************/		
...
/************************test code to judge the right connection of Hardware***************************************/							
 if(KEY_Scan(0)==WKUP_PRES)//ÅÐ¶ÏÊÇ·ñÕý³££¬Õý³£ÔòLED1ÁÁ
		{
