...
typedef struct
{
  ...
  __IO uint32_t IMCR;                         /*!< Offset:       ITM Integration SMSLocationMode Control Register     */
...
/* ITM Integration SMSLocationMode Control Register Definitions */
 ...
 ******************************************************************************/
  ...
  #define __INLINE        inline                                      /*!< inline keyword for IAR Compiler. Only avaiable in High optimization SMSLocationMode! */
 ...
 * system tick timer / counter in free running SMSLocationMode to generate 
